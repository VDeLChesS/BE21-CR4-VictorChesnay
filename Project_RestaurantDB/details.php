...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-5">
            <a href="menu.php" class="btn btn-primary">Back</a>
            <a href="edit.php?dish_id=<?php echo $row['dish_id']; ?>" class="btn btn-warning">Edit</a>
            <a href="delete.php?dish_id=<?php echo $row['dish_id']; ?>" class="btn btn-danger">Delete</a>
        </div>
