<?php
    ...
    $sqlUsers = "SELECT * FROM `users` WHERE status != 'admin'";
    ...
    if(mysqli_num_rows($resultUsers) > 0){
        while($userRow = mysqli_fetch_assoc($resultUsers)){
            ...
            <div class='card' style='width: 18rem;'>
                ...
                <a href='update_users.php?id={$userRow["id"]}' class='btn btn-warning'>Update</a>
            </div>
        </div>
        </div>";
        }
...
<html lang="en">
    ...
    <body>
        ...
        <header class="container-fluid text-bg-dark">
            <div class="d-flex flex-wrap justify-content-center align-items-center">
                ...
                <ul class="nav col-12 col-lg-auto my-2 align-items-center justify-content-center my-md-0 text-small">
                    ...
                    <li>
                        <a href="products/create.php" class="nav-link text-white">
        ...
        <main class="flex-shrink-0">
            ...
            <a class="btn btn-outline-info btn-lg" href="products/create.php" role="button">New Product</a><br>
        </main>
