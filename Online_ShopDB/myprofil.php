    ...
    $layout .= "
        <div class='container-fluid'>
            ...
            <div class='container'>
                ...
                <h3 class='fw-bold'>Address: Email {$row["email"]}</h3>
                <h5 class='fw-bold'>Date of Birth: {$row["date_of_birth"]}</h5>
                <h5 class='fw-bold'>Address: {$row["address"]}</h5>
                <h5 class='fw-bold'>Status: {$row["status"]}</h5>
            </div>
            <div class='footer'>
                <a href='update_myprofil.php?id={$row["id"]}' class='btn btn-warning'>Update</a>
        ...
        <div class="w3-third">
            ...
            <div class="w3-white w3-text-grey w3-card-4">
                ...
                <div class="w3-container">
                    ...
                    <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i><?=$row["address"]?></p>
