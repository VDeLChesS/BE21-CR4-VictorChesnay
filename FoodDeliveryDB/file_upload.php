...
function fileUpload($picture){
    if($picture["error"] == 4){ // checking if a file has been selected, it will return 0 if you choose a file, and 4 if you didn't
        $pictureName = "aligot.jpg"; // the file name will be product.png (default picture for a product)
       ...
       if($message == "Ok"){
           $ext = strtolower(pathinfo($picture["dish_name"],PATHINFO_EXTENSION)); // taking the extension data from the image
